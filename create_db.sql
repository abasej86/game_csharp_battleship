...
/****** Object:  Database [project2]    Script Date: 2018-11-03 10:15:21 AM ******/
CREATE DATABASE [project2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'project2', FILENAME = N'C:\dev\data\mssql12\project2.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'project2_log', FILENAME = N'C:\dev\log\mssql12\project2_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
